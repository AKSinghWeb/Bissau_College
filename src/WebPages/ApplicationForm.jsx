...
const ApplicationForm = () => {
  ...
  return (
    <div>
      <div className='flex px-3 justify-center pt-5 pb-20'>
        <form
          data-aos='fade-up'
          className='border max-md:w-full border-cyan-600 lg:w-[1000px] p-5 lg:p-20'
        >
          <div className='flex justify-center w-full'>
            <img src={Img} className='w-[250px]' alt='' />
          </div>
          <p className='text-4xl max-md:text-3xl font-semibold text-cyan-600 pb-5'>
            Application Form for 2024-25
          </p>
