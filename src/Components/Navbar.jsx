  ...
  return (
    <div className='lg:px-20 px-5 bg-gray-200'>
      ...
      <div className='lg:flex justify-between items-center'>
        ...
        <div className='flex max-md:flex grid-cols-2 text-xl max-md:text-base items-center gap-5'>
          <Link className='max-md:text-sm hover:text-cyan-600' to={'/'}>
            Home
          </Link>
          <Link className='max-md:text-sm hover:text-cyan-600' to={'/academics'}>
            Academics
          </Link>
          <Link className='max-md:text-sm hover:text-cyan-600' to={'/about'}>
            About
          </Link>
          <Link className='max-md:text-sm hover:text-cyan-600' to={'/admission-2024-25'}>
            <button className='p-2 max-md:text-sm max-md:mb-3 min-w-max px-5 animate__animated animate__backInRight rounded-full hover:bg-cyan-700 bg-cyan-600 text-white'>
              Admission 2024-25
            </button>
          </Link>
        </div>
